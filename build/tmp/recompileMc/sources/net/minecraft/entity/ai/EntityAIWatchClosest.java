...
public class EntityAIWatchClosest extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                this.closestEntity = this.theWatcher.world.getClosestPlayer(this.theWatcher.posX, this.theWatcher.posY, this.theWatcher.posZ, (double)this.maxDistanceForPlayer, Predicates.and(EntitySelectors.NOT_SPECTATING, EntitySelectors.notRiding(this.theWatcher)));
            }
            else
            {
