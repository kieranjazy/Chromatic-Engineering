...
public class Chunk
{
    ...
    private int getBlockLightOpacity(int x, int y, int z)
    {
        ...
        return !isChunkLoaded ? state.getLightOpacity() : state.getLightOpacity(world, new BlockPos(this.xPosition << 4 | x & 15, y, this.zPosition << 4 | z & 15));
    }
    ...
    public int getLightFor(EnumSkyBlock p_177413_1_, BlockPos pos)
    {
        ...
        {
            return !this.world.provider.hasSkyLight() ? 0 : extendedblockstorage.getExtSkylightValue(i, j & 15, k);
        }
        else
        {
