...
public abstract class Container
{
    ...
    public void func_192388_b(int p_192388_1_, ItemStack p_192388_2_)
    {
        ...
        else if (itemstack.getUnlocalizedName().equals(p_192388_2_.getUnlocalizedName()) && itemstack.getCount() < itemstack.getMaxStackSize())
        {
            itemstack.grow(p_192388_2_.getCount());
        }
    }
